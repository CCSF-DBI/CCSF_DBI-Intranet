...
define([
	...
	'modules/permitServices/permitServicesMod',
	'modules/inspectionServices/inspectionServicesMod',
	'modules/supportServices/supportServicesMod',
	'modules/dbi/staffCollectionView'
],
function ($, _, Backbone, Handlebars, Marionette, Cookie, Bootstrap, appEvents, AppLayout, SideNav, homeViewMod, permitServicesMod, inspectionServicesMod, supportServicesMod, StaffCollection) {
	...
	App.module("permitServices", {moduleClass: permitServicesMod});
	App.module("inspectionServices", {moduleClass: inspectionServicesMod});
	App.module("supportServices", {moduleClass: supportServicesMod});
	...
	App.renderStaffMembers = function (staffarray) {
		...
		$.each(staffarray, function() {
			...
			this.email = this.email ? this.email : String(this.firstname + " " + this.lastname).replace(/'/g, "").replace(/ /g, ".");
